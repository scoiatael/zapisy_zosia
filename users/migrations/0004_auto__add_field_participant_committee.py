...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.committee'
        db.add_column(u'users_participant', 'committee',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.committee'
        db.delete_column(u'users_participant', 'committee')
