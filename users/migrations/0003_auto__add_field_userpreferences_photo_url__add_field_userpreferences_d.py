...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPreferences.photo_url'
        db.add_column(u'users_userpreferences', 'photo_url',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserPreferences.description'
        db.add_column(u'users_userpreferences', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=2048, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPreferences.photo_url'
        db.delete_column(u'users_userpreferences', 'photo_url')

        # Deleting field 'UserPreferences.description'
        db.delete_column(u'users_userpreferences', 'description')
    ...
    models = {
        ...
        u'common.zosiadefinition': {
            ...
            'bus_limit': ('django.db.models.fields.IntegerField', [], {'default': '90'}),
