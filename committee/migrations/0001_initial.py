...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Vote'
        db.create_table(u'committee_vote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Participant'])),
            ('lecture', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lectures.Lecture'])),
        ...
        db.send_create_signal(u'committee', ['Vote'])


    def backwards(self, orm):
        # Deleting model 'Vote'
        db.delete_table(u'committee_vote')
    ...
    models = {
        ...
        u'committee.vote': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lecture': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lectures.Lecture']"}),
