...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lecture.abstract'
        db.alter_column(u'lectures_lecture', 'abstract', self.gf('django.db.models.fields.TextField')(max_length=768))

    def backwards(self, orm):

        # Changing field 'Lecture.abstract'
        db.alter_column(u'lectures_lecture', 'abstract', self.gf('django.db.models.fields.TextField')(max_length=512))
