...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lecture.for_committe'
        db.add_column(u'lectures_lecture', 'for_committe',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lecture.for_committe'
        db.delete_column(u'lectures_lecture', 'for_committe')
