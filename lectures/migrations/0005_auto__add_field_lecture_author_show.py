...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lecture.author_show'
        db.add_column('lectures_lecture', 'author_show',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lecture.author_show'
        db.delete_column('lectures_lecture', 'author_show')
