...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ZosiaDefinition.bus_limit'
        db.add_column(u'common_zosiadefinition', 'bus_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=90),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ZosiaDefinition.bus_limit'
        db.delete_column(u'common_zosiadefinition', 'bus_limit')
